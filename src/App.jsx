...
export default function App() {
  ...
  function openManualForm(log = null) {
    if (log) {
      ...
      const option = WORK_OPTIONS.find((i) => i.id === "engine_service");
  ...
  function deleteLog(id) {
    ...
    const nextData = { ...data, logs: data.logs.filter((log) => log.id !== id) };
    setData(nextData);
    setTimeout(() => analyzeVehicle(nextData, profile, vehicle), 300);
  }
      ...
      <div className="app">
        <div className="onboard">
          <div className="onboard-hero">
            ...
            <div className="onboard-sub">Умный дневник обслуживания вашего автомобиля</div>
          </div>
